...
public class TournamentTest {
    ...
    void lineupTestWith4Players() {
        ...
        Tournament tournament = new Tournament(TOURNAMENT_ID, Organizer.KVTK, DATE, "BVSC Tour", "BVSC", Type.SIMPLE_BOARD, 1, contestants, Status.DRAFT, List.of(new Tournament.Board(2, Map.of())));
    ...
    void lineupTestWith6Players() {
        ...
        Tournament tournament = new Tournament(TOURNAMENT_ID, Organizer.KVTK, DATE, "BVSC Tour", "BVSC", Type.SIMPLE_BOARD, 1, contestants, Status.DRAFT, List.of(new Tournament.Board(3, Map.of())));
