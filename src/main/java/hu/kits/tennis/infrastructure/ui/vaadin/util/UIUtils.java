...
import hu.kits.tennis.infrastructure.ui.vaadin.util.css.AlignSelf;
...
import hu.kits.tennis.infrastructure.ui.vaadin.util.css.FlexWrap;
import hu.kits.tennis.infrastructure.ui.vaadin.util.css.JustifyContent;
...
import hu.kits.tennis.infrastructure.ui.vaadin.util.css.Shadow;
import hu.kits.tennis.infrastructure.ui.vaadin.util.css.TextAlign;
import hu.kits.tennis.infrastructure.ui.vaadin.util.css.TextOverflow;
import hu.kits.tennis.infrastructure.ui.vaadin.util.css.WhiteSpace;
...
public class UIUtils {
     ...
     */
    private static final ThreadLocal<DecimalFormat> decimalFormat = ThreadLocal.withInitial(() -> new DecimalFormat("###,###.00", DecimalFormatSymbols.getInstance(Locale.US)));
    ...
    public static NativeLabel createLabel(FontSize size, TextColor color, String text) {
