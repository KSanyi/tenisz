package hu.kits.tennis.infrastructure.ui.vaadin.components.navigation.tab;
...
public class NaviTabs extends Tabs {
    ...
    /**
     * When adding the first tab, the selection change event is triggered. This will
     * cause the app to navigate to that tab's navigation target (if any). This
     * constructor allows you to add the tabs before the event listener is set.
     */
